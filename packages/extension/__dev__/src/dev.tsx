...
function App() {
  ...
  useLayoutEffect(() => {
    ...
    const agentUserId = qs.get('agentUserId') ? qs.get('agentUserId')! : '1';
    const tenantId = qs.get('tenantId') ? qs.get('tenantId')! : '1';
    const username = qs.get('username') ? qs.get('username')! : 'kuangkuang';
    // https://develop.1024paas.com/?agentUserId=1&username=eric&tenantId=1&playground 364948495318253568Id=364948495318253568&ticket=MXwzNjQ5NDg0OTUzMTgyNTM1Njh8MXxudWxsfDE4OTU2NTMzODMwMDA=
