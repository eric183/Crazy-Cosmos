    ...
    (set) =>
      ({
        ...
        setCRDTInfo: (arg: Dao_FrontType.CRDT) =>
          set(() => ({ CRDTInfo: { ...arg, agentUserId: arg.agentUserId! } })),
...
export const userStore = create<{
  ...
  persist(
    (set) => ({
      userInfo: {} as unknown as DaoUserInfo,
      ...
      switchShadowUser: (id?: string) =>
        set(() => {
          ...
          if (id !== undefined) {
            user = userListStore
              .getState()
              .userList.find((user) => user.agentUserId === id)!;
          ...
          //   .getState()
          //   .userList.find((x) => x.agentUserId === arg.agentUserId?.toString())!;
...
export const userListStore = create<{
  ...
  persist(
    (set) => ({
      ...
      setUserList: (arg: DaoUserInfo[]) =>
        set(() => ({ userList: arg.filter((x) => x.agentUserId) })),
    }),
    {
      name: 'userList',
      getStorage: () => ({
