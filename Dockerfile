...
# RUN printf "NODE_ENV=${DOCKER_ENV}\n..."
# RUN printf "${NODE_ENV}\n!!!"
...
COPY --from=builder /app/packages/d42paas-official/.next /app/packages/server/.next
COPY --from=builder /app/packages/d42paas-official/public /app/packages/server/public
